...
mod tests {
    ...
    #[test]
    fn add_5_and_6() {
        let a: (usize, usize, usize, usize) = (0, 1, 0, 1);
        let b: (usize, usize, usize, usize) = (0, 1, 1, 0);
        assert_eq!(four_bit_adder(a, b), (1, 0, 1, 1));
    }

    #[test]
    fn add_3_and_7() {
        let a: (usize, usize, usize, usize) = (0, 0, 1, 1);
        let b: (usize, usize, usize, usize) = (0, 1, 1, 1);
        assert_eq!(four_bit_adder(a, b), (1, 0, 1, 0));
    }
}
